...
private data class ReleaseArtifact(val fileName: String, val sha256: String) {
    ...
    companion object {
        ...
        fun qnnPipeline(target: QualcommTargetSoc): ReleaseArtifact = when (target) {
            ...
            QualcommTargetSoc.SNAPDRAGON_8_GEN_5 -> ReleaseArtifact("v2pp-sm8845-pipeline.qnn.gsvm", "a90d92bb80cebd276e1f7d42887aefb396549d6579de3f0ff8049a5a345ac172")
        }
        fun qnnFirefly(target: QualcommTargetSoc): ReleaseArtifact = when (target) {
            ...
            QualcommTargetSoc.SNAPDRAGON_8_GEN_5 -> ReleaseArtifact("firefly-v2pp-sm8845.qnn.gsvm", "b1cdec977f787a0bdc9f9f61f4c83d4754703552430c6ce05c19662a1130beb2")
        }
    }
}
