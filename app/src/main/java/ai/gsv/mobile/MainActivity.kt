...
private data class ReleaseArtifact(val fileName: String, val sha256: String) {
    ...
    companion object {
        ...
        fun qnnPipeline(target: QualcommTargetSoc): ReleaseArtifact = when (target) {
            ...
            QualcommTargetSoc.SNAPDRAGON_8_GEN_5 -> ReleaseArtifact("v2pp-sm8845-pipeline.qnn.gsvm", "ca12d67a542112c632231829be2aa4ee82dbfd95327d874845428d37c4cc523c")
        }
        fun qnnFirefly(target: QualcommTargetSoc): ReleaseArtifact = when (target) {
            ...
            QualcommTargetSoc.SNAPDRAGON_8_GEN_5 -> ReleaseArtifact("firefly-v2pp-sm8845.qnn.gsvm", "f3d17bffde7133299b8c3429a636b2b82d89d7ad8caa37c3144630460ffe4f10")
        }
    }
}
